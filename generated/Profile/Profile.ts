...
export class Profile extends ethereum.SmartContract {
  ...
  numberCakeToReactivate(): BigInt {
    let result = super.call(
      "numberCakeToReactivate",
      "numberCakeToReactivate():(uint256)",
      []
    );
  ...
  try_numberCakeToReactivate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "numberCakeToReactivate",
      "numberCakeToReactivate():(uint256)",
      []
  ...
  numberCakeToRegister(): BigInt {
    let result = super.call(
      "numberCakeToRegister",
      "numberCakeToRegister():(uint256)",
      []
    );
  ...
  try_numberCakeToRegister(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "numberCakeToRegister",
      "numberCakeToRegister():(uint256)",
      []
  ...
  numberCakeToUpdate(): BigInt {
    let result = super.call(
      "numberCakeToUpdate",
      "numberCakeToUpdate():(uint256)",
      []
    );
  ...
  try_numberCakeToUpdate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "numberCakeToUpdate",
      "numberCakeToUpdate():(uint256)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _cakeToken(): Address {
    return this._call.inputValues[0].value.toAddress();
  }

  get _numberCakeToReactivate(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _numberCakeToRegister(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get _numberCakeToUpdate(): BigInt {
...
export class UpdateNumberCakeCall extends ethereum.Call {
  get inputs(): UpdateNumberCakeCall__Inputs {
    return new UpdateNumberCakeCall__Inputs(this);
  }

  get outputs(): UpdateNumberCakeCall__Outputs {
    return new UpdateNumberCakeCall__Outputs(this);
  }
}

export class UpdateNumberCakeCall__Inputs {
  _call: UpdateNumberCakeCall;

  constructor(call: UpdateNumberCakeCall) {
    this._call = call;
  }

  get _newNumberCakeToReactivate(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _newNumberCakeToRegister(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _newNumberCakeToUpdate(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }
}

export class UpdateNumberCakeCall__Outputs {
  _call: UpdateNumberCakeCall;
